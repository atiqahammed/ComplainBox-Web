<?php  
	...
	$email['body'] = "You can recover your account from the following link. This link will be valid for 2 hours only. 10.100.104.65/SERVER/serverHTML/resetPassword.php?recoveryid=".$new_id."";
	$email['to'] = $row[0];
